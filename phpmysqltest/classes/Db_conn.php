...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'sbsamaha';//this will be your WCC username
      $dbUsr = 'sbsamaha';//this will be your WCC username
      $dbPass = '2xeQzXVRrEbq';//this will be the password found in the video.
